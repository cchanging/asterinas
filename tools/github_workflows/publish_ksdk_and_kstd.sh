...
for TARGET in $TARGETS; do
    do_publish_for kstd/libs/kstd-macros $TARGET
    do_publish_for kstd/libs/kstd-test $TARGET
    do_publish_for kstd/libs/linux-bzimage/setup $TARGET
    do_publish_for kstd $TARGET
    do_publish_for ksdk/test-kernel $TARGET
