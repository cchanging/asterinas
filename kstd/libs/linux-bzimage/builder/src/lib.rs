...
//!
//! We should build the astros kernel as an ELF file, and feed it to the builder to
...
/// To build the legacy32 bzImage setup header, the KSDK should use this target.
...
/// `kstd/src/arch/x86/boot/linux_boot/setup/src/header.S` for more
