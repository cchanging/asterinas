...
//! The standard library for Astros and other Rust OSes.
...
pub use kstd_macros::{main, panic_handler};
pub use kstd_pod::Pod;
...
/// all functionalities of KSTD available after the call.
///
/// # Safety
///
...
#[doc(hidden)]
pub mod ktest {
    //! The module re-exports everything from the [`kstd_test`] crate, as well
    ...
    pub use kstd_macros::{test_main as main, test_panic_handler as panic_handler};
    pub use kstd_test::*;
}
