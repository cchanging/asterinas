...
///
/// The builder must contains the memory I/O regions that don't belong to the physical memory. Also, KSTD
...
impl IoMemAllocatorBuilder {
    ...
    ///
    /// All drivers in KSTD must use this method to prevent peripheral drivers from accessing illegal memory I/O range.
