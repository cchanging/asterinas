...
/// Fields of a task that KSTD will never touch.
///
/// The type ought to be defined by the KSTD user and injected into the task.
...
/// exist yet. So we decide to define them in KSTD.
#[derive(Debug)]
