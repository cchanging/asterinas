...
//! Scheduling subsystem (in-KSTD part).
//!
//! This module defines what KSTD expects from a scheduling implementation
...
pub(super) fn run_new_task(runnable: Arc<Task>) {
    ...
    // Currently KSTD cannot know whether its user has injected a scheduler.
    ...
    F: FnMut(&mut dyn LocalRunQueue) -> ReschedAction,
{
    ...
    // should be fixed. See <https://github.com/astros/astros/issues/1471> for details.
