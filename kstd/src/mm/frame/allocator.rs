...
///
/// KSTD allows a customized frame allocator by the [`global_frame_allocator`]
...
///
/// Whenever KSTD or other modules need to allocate or deallocate frames via
...
pub trait GlobalFrameAllocator: Sync {
    ...
    ///
    /// When any of the allocated memory is not in use, KSTD returns them by
