...
//! The RISC-V boot module defines the entrypoints of Astros.
...
/// The entry point of the Rust code portion of Astros.
#[no_mangle]
pub extern "C" fn riscv_boot(_hart_id: usize, device_tree_paddr: usize) -> ! {
    ...
    use crate::boot::{call_kstd_main, EarlyBootInfo, EARLY_INFO};
