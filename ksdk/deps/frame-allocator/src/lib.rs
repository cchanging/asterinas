...
//! [KSTD](https://crates.io/crates/kstd) based kernels.
//!
//! # Background
//!
//! `KSTD` has provided a page allocator interface, namely [`GlobalFrameAllocator`]
...
//! [`kstd::mm::frame::allocator`] module for detailed introduction.
//!
//! # Introduction
//!
//! This crate is an implementation of a scalable and efficient global frame
//! allocator based on the buddy system. It is by default shipped with KSDK
//! for users that don't have special requirements on the frame allocator.
//!
//! [`GlobalFrameAllocator`]: kstd::mm::GlobalFrameAllocator
//! [`global_frame_allocator`]: kstd::global_frame_allocator
...
/// The global frame allocator provided by KSDK.
///
