...
//! KSDK profile command implementation.
//!
...
fn test_profile_parse_raw() {
    let test_case = r#"
0xffffffff880b0f6f in astros_nix::sched::priority_scheduler::{impl#4}::pick_next_current<kstd::task::Task> (self=0xffffffff88489808 <_ZN4kstd2mm14heap_allocator10HEAP_SPACE17h85a5340e6564f69dE.llvm.15305379556759765072+992480>) at src/sched/priority_scheduler.rs:156
156	        let next_entity = if !self.real_time_entities.is_empty() {

Thread 2 (Thread 1.2 (CPU#1 [running])):
#0  kstd::sync::spin::SpinLock<astros_nix::sched::priority_scheduler::PreemptRunQueue<kstd::task::Task>, kstd::sync::spin::PreemptDisabled>::acquire_lock<astros_nix::sched::priority_scheduler::PreemptRunQueue<kstd::task::Task>, kstd::sync::spin::PreemptDisabled> (...)
#1  kstd::sync::spin::SpinLock<astros_nix::sched::priority_scheduler::PreemptRunQueue<kstd::task::Task>, kstd::sync::spin::PreemptDisabled>::lock<astros_nix::sched::priority_scheduler::PreemptRunQueue<kstd::task::Task>, kstd::sync::spin::PreemptDisabled> (...)
#2  astros_nix::sched::priority_scheduler::{impl#1}::local_mut_rq_with<kstd::task::Task> (...)
#3  0xffffffff8826b205 in kstd::task::scheduler::reschedule<kstd::task::scheduler::yield_now::{closure_env#0}> (...)
#4  kstd::task::scheduler::yield_now ()
#5  0xffffffff880a92c5 in kstd::task::Task::yield_now ()
#6  astros_nix::thread::Thread::yield_now ()
#7  astros_nix::ap_init::ap_idle_thread ()
...
#10 astros_nix::thread::kernel_thread::create_new_kernel_task::{closure#0} ()
...
#12 kstd::task::{impl#2}::build::kernel_task_entry ()
#13 0x0000000000000000 in ?? ()

Thread 1 (Thread 1.1 (CPU#0 [running])):
#0  astros_nix::sched::priority_scheduler::{impl#1}::local_mut_rq_with<kstd::task::Task> (...)
#1  0xffffffff8826b205 in kstd::task::scheduler::reschedule<kstd::task::scheduler::yield_now::{closure_env#0}> (...)
#2  kstd::task::scheduler::yield_now ()
#3  0xffffffff880a92c5 in kstd::task::Task::yield_now ()
#4  astros_nix::thread::Thread::yield_now ()
#5  astros_nix::ap_init::ap_idle_thread ()
...
#8  astros_nix::thread::kernel_thread::create_new_kernel_task::{closure#0} ()
...
#10 kstd::task::{impl#2}::build::kernel_task_entry ()
...
Thread 2 (Thread 1.2 (CPU#1 [running])):
#0  0xffffffff880b0f6f in astros_nix::sched::priority_scheduler::{impl#4}::pick_next_current<kstd::task::Task> (...)
#1  0xffffffff8826b3e0 in kstd::task::scheduler::yield_now::{closure#0} (...)
#2  kstd::task::scheduler::reschedule::{closure#0}<kstd::task::scheduler::yield_now::{closure_env#0}> (...)
#3  0xffffffff880b0cff in astros_nix::sched::priority_scheduler::{impl#1}::local_mut_rq_with<kstd::task::Task> (...)
#4  0xffffffff8826b205 in kstd::task::scheduler::reschedule<kstd::task::scheduler::yield_now::{closure_env#0}> (...)
#5  kstd::task::scheduler::yield_now ()
#6  0xffffffff880a92c5 in kstd::task::Task::yield_now ()
#7  astros_nix::thread::Thread::yield_now ()
#8  astros_nix::ap_init::ap_idle_thread ()
...
#11 astros_nix::thread::kernel_thread::create_new_kernel_task::{closure#0} ()
...
#13 kstd::task::{impl#2}::build::kernel_task_entry ()
#14 0x0000000000000000 in ?? ()

Thread 1 (Thread 1.1 (CPU#0 [running])):
#0  kstd::arch::x86::interrupts_ack (...)
#1  0xffffffff8828d704 in kstd::trap::handler::call_irq_callback_functions (...)
#2  0xffffffff88268e48 in kstd::arch::x86::trap::trap_handler (...)
...
#9  0xffffffff88489808 in _ZN4kstd2mm14heap_allocator10HEAP_SPACE17h85a5340e6564f69dE.llvm.15305379556759765072 ()
...
"#;
    ...
    assert_eq!(
        stack00[0],
        "astros_nix::sched::priority_scheduler::local_mut_rq_with"
    );
    ...
    assert_eq!(
        stack10[9],
        "_ZN4kstd2mm14heap_allocator10HEAP_SPACE17h85a5340e6564f69dE.llvm.15305379556759765072"
    );
    ...
    assert_eq!(
        stack11[0],
        "astros_nix::sched::priority_scheduler::pick_next_current"
    );
